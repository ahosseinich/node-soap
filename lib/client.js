...
Client.prototype._defineMethod = function (method, location) {
  ...
  return function (args, callback, options, extraHeaders) {
    ...
    self._invoke(method, args, location, function (error, result, raw, soapHeader, wholeResponse) {
      callback(error, result, raw, soapHeader, wholeResponse);
...
Client.prototype._invoke = function (method, args, location, callback, options, extraHeaders) {
  ...
  function finish(obj, body, response) {
    ...
    if (!output) {
      ...
      return callback(null, null, body, obj.Header, response);
    }
    ...
    if (typeof obj.Body !== 'object') {
      ...
      error.response = response;
      error.body = body;
      return callback(error, obj, body, response);
    }

    // if Soap Body is empty
    if (!obj.Body) {
      return callback(null, obj, body, obj.Header, response);
    }
    ...
    callback(null, result, body, obj.Header, response);
  }
